<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Dealer Section</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
            ...
            <div class="col-lg-offset-1 col-lg-10">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <i class="fa fa-bell fa-fw"></i>Dealer<a href="#" data-toggle="modal" data-target="#myModal" ><i class="fa fa-plus-circle fa-2x pull-right"></i></a>
                    </div>
                    <!-- /.panel-heading -->
