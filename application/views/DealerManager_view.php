    ...
    <div class="row content-container">
        ...
        <div class="container-fluid">
                    ...
                    <div class="col-lg-offset-1 col-lg-10">
                        <div class="panel panel-info">
                            <div class="panel-heading">
                                    ...
                                    <div class="title"><i class="fa fa-magnet fa-fw"></i>Dealer Manager <span class="pull-right"><a href="#" data-toggle="modal" data-target="#myModal" ><i class="fa fa-plus-circle"></i></a> </span></div>
                                ...
                                <div class="dataTable_wrapper">
                                    <table class="table table-striped table-bordered table-hover" id="company_table">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($alldealer as $key => $value) {
                                                ?>
                                                <tr class="odd gradeX">
                                                    <td><?= $value->id ?></td>
                                                    <td><?= $value->name ?></td>
            ...
            <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                <form role="form" action="<?php echo base_url('index.php/DealerManager/addDealer') ?>" method="post">
            ...
            <div class="modal fade" id="updateModel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                <form role="form" action="<?php echo base_url('index.php/DealerManager/updateDealer') ?>" method="post">
                    <div class="modal-dialog  ">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                ...
                table.on('click', '#delete', function () {
                    ...
                    $.confirm({
                        ...
                        confirm: function () {
                            console.log(data);
                            id = data[0];
                            console.log("<?php echo base_url('index.php/DealerManager/deleteDealer/') . "/" ?>" + id);
                            window.location.href = "<?php echo base_url('index.php/DealerManager/deleteDealer/') . "/" ?>" + id
                        },
                        cancel: function () {
                        }
                    });
